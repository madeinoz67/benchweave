...
from benchweave.devices.fnirsi.dps150.adapter import create_plugin
from benchweave.devices.fnirsi.dps150.descriptor import build_descriptor

ROOT = Path(__file__).resolve().parents[4]
PACKAGE = ROOT / "src/benchweave/devices/fnirsi/dps150"
SCHEMAS = ROOT / "docs/otdp-v0.3.0"
