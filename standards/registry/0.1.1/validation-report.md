...
Checked three Draft 2020-12 schemas, positive metadata fixtures, missing required fields, conditional executable requirements, path/version/role-enum restrictions and selected cross-field cases. These checks do not exercise a registry, TUF signatures, dependency resolution, payload integrity or hardware. Example digests, source/provider IDs and URLs are synthetic and not installable artefacts.
