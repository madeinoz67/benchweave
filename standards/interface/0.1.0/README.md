...
corpus — not an edit of `interface/0.1.0`. The 1.1.0 corpus remains vendored
at `standards/interface/0.1.0/` with its bytes frozen; this revision is
housed at `standards/interface/0.1.0/` and recorded in
...
- Source of truth: `standards/interface/0.1.0/` (this directory; machine
