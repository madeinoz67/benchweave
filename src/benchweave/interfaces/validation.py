...
#: dev checkout — :mod:`benchweave.vendoring`). interface/1.1.1 is the D2
...
#: frozen, at ``contracts/interface/1.1.0/``.
VENDORED_CORPUS_ROOT = contract_family("interface/1.1.1")
