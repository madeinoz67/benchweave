...
The descriptor declares the integration in both cases. Communication inside BenchWeave uses admitted host transport. The [reference controller](../standards/otdp/0.1.0/examples/reference-controller.json) and [reference exchanges](../standards/otdp/0.1.0/examples/reference-protocols.md) are synthetic authoring examples, not ready-to-flash firmware or evidence for your board.
...
**Ready to continue:** firmware, descriptor and any adapter agree, and applicable conformance checks pass. The [core specification](../standards/otdp/0.1.0/otdp-specification.md), [profile extension](../standards/otdp/0.1.0/extension-contract.md) and [measurement model](../standards/otdp/0.1.0/measurement-model.md) define the requirements; these prompts add none.
