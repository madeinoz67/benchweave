...
Read the [core specification](../standards/otdp/0.3.0/otdp-specification.md), [profile/adapter extension](../standards/otdp/0.3.0/extension-contract.md), [device classes](../standards/otdp/0.3.0/device-classes.md) and [measurement model](../standards/otdp/0.3.0/measurement-model.md) before writing a class-capable integration. The [documentation index](project-index.md) links the remaining contracts.
...
Use the [descriptor schema](../standards/otdp/0.3.0/otdp-device-descriptor.schema.json) and a suitable [class descriptor example](../standards/otdp/0.3.0/examples/class-dc_psu.json) as references. Copying a fixture does not transfer its evidence to your hardware.
...
The normative factory and methods are in [core specification §8](../standards/otdp/0.3.0/otdp-specification.md#8-python-adapter-abi-11). They use structural Python interfaces. The optional [plugin SDK](plugin-sdk.md) supplies typing protocols, offline validation and mocks for development; plugin runtime code need not import it.
...
Use the [synthetic controller descriptor](../standards/otdp/0.3.0/examples/reference-controller.json), [reference protocol](../standards/otdp/0.3.0/examples/reference-protocols.md) and [runtime schema](../standards/otdp/0.3.0/otdp-runtime.schema.json) for exact examples. They are authoring targets, not ready-to-flash ESP32 firmware.
...
See the [measurement model](../standards/otdp/0.3.0/measurement-model.md) for all M01–M14 rules and the [extension contract](../standards/otdp/0.3.0/extension-contract.md) for host method signatures.
...
3. **Create local bench records.** Bind `connection_key` to the commissioned instance. Maintain wiring, channel/resource maps, safety policy, procedure, commissioning and package lock separately from shared descriptors. Follow the [execution contract](../standards/execution/1.0.0/execution-contract.md).
