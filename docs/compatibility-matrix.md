...
| --- | --- | --- | --- | --- | --- | --- |
| otdp | 0.2.2 | stable | 0.3.1 | >=0.1.0 | Supersedes 0.2.1 | [main repo](https://github.com/madeinoz67/benchweave) · [sdk repo](https://github.com/madeinoz67/benchweave-sdk) |
| registry | 0.1.1 | stable | 0.3.1 | >=0.1.0 | Supersedes 0.1.0 | [main repo](https://github.com/madeinoz67/benchweave) · [sdk repo](https://github.com/madeinoz67/benchweave-sdk) |
| execution | 0.2.0 | stable | 0.3.1 | >=0.1.0 | Supersedes 0.1.0 | [main repo](https://github.com/madeinoz67/benchweave) · [sdk repo](https://github.com/madeinoz67/benchweave-sdk) |
