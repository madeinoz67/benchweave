...
The current project baseline is architecture 1.5, OTDP 0.3.0, adapter API 1.1, registry 1.0.0, execution 1.0.0 and interface 1.1.0. If a candidate declares another version, obtain the corresponding contract; do not silently judge it against a different one.
...
- [OTDP core and S01–S18](otdp-v0.3.0/otdp-specification.md)
- [Adapter/profile extension and C01–C12](otdp-v0.3.0/extension-contract.md)
- [Measurement model and M01–M14](otdp-v0.3.0/measurement-model.md)
- [Device classes](otdp-v0.3.0/device-classes.md)
