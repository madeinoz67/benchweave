...
The current project baseline is architecture 1.5, OTDP 0.2.0, adapter API 1.1, registry 0.1.0, execution 0.1.0 and interface 0.1.0. If a candidate declares another version, obtain the corresponding contract; do not silently judge it against a different one.
