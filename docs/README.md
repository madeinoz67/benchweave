...
**Design baseline:** STG 1.5 · OTDP 0.1.1 · Python adapter API 1.1  
...
| [Extension contract](../standards/otdp/0.1.1/extension-contract.md) | Typed actions, local schema admission and adapter API 1.1 |
